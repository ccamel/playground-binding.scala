...
libraryDependencies ++= Seq(
  ...
  "com.thoughtworks.binding" %%% "dom" % "11.6.1",
  "com.thoughtworks.binding" %%% "route" % "11.6.1",
  "org.scalatest" %%% "scalatest" % "3.0.7" % "test",
  "org.scalatest" %% "scalatest" % "3.0.7" % "test" // FIXME: https://github.com/scalatest/scalatest/issues/911
)
